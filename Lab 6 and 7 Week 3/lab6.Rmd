...
## Part 1: Working with Ego Network Data in R
...
```
Visualizing really helps me better understand the network!
...
```
- Coloring makes a big difference: much easier to see patterns
...
```
- really cool to compare to chance
- thinking of how this could be applied to capstone project
...
```
- sex and race diversity returning na 
...
```
- Getting error with DENSITY: seems like some items are a list?

# Part 5: Working with One File to do Ego Network Analysis (Supplementary Section)
